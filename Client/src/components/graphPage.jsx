...
export default function GraphPage({ entries = [], userName = "" }) {
  ...
  // Verification si il existe des données Garmin
  ...
  return (
    <div className="gp-root">
      ...
      <div className="gp-header">
        ...
        {/* Right side: period selector + export button */}
      ...
      <div className="gp-charts-grid">
        ...
        {/* Quality comparison: subjective vs Garmin */}
        <ChartCard
          title={
            hasGarminData
